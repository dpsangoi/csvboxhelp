...
| [type](../dashboard-settings/sheet-options.md#column-type)                                            | It specifies the data type of the incoming data. Possible values are: **text**, **number**, **email**, **date**, **boolean**, **regex**, **ip**, **url**, **credit\_card**, **phone\_number, list,** and **dynamic\_list**. |
...
| dynamic\_list | <ol><li><strong>api</strong></li><li><strong>case_sensitive</strong></li></ol>    | <p><br> "api": { <br>"method": "POST", <br>"url": "https://api.myapp.com/list", "request_headers": [ <br>{ <br>"Content-Type": "application/json", "X-Access-Token": "71ab1d73a4d1319bdbc1c" }, <br>{<br>"Content-Type": "application/json", "UserId": "78687" <br>}<br>] <br>}, <br>"case_sensitive": false </p> |
|               |                                                                                   |                                                                                                                                                                                                                                                                                                                   |
