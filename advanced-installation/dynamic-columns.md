...
| [type](../dashboard-settings/sheet-options.md#column-type)                                            | It specifies the data type of the incoming data. Possible values are: **text**, **number**, **email**, **date**, **boolean**, **regex**, **ip**, **url**, **credit\_card**, **phone\_number, list, dynamic\_list** and **dependent\_dynamic\_list**. |
