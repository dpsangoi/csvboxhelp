...
* [Getting Started](getting-started/README.md)
  * [1. Add Template](getting-started/1.-add-template.md)
  * [2. Install Code](getting-started/2.-install-code.md)
  * [3. Receive Data](getting-started/3.-receive-data.md)
* [Template Settings](template-settings/README.md)
  * [Sheet Options](template-settings/sheet-options.md)
  * [Add Columns via CSV](template-settings/add-columns-via-csv.md)
  * [Validations](template-settings/validations.md)
